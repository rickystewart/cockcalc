...
var author$project$Main$ingredientToProperties = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'Carpano Antica Formula',
			{acidity: 0.6, ethanol: 16.5, sugar: 16.0}),
			_Utils_Tuple2(
			'Dolan Blanc',
			{acidity: 0.6, ethanol: 16.0, sugar: 13.0}),
			_Utils_Tuple2(
			'Dolin Dry',
			{acidity: 0.6, ethanol: 17.5, sugar: 3.0}),
			_Utils_Tuple2(
			'Dolin Rouge',
			{acidity: 0.6, ethanol: 16.0, sugar: 13.0}),
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			'Lillet Blanc',
			{acidity: 0.6, ethanol: 17.0, sugar: 9.5}),
			_Utils_Tuple2(
			'Martinelli',
			{acidity: 0.6, ethanol: 16.0, sugar: 10.0}),
			_Utils_Tuple2(
			'Amaro CioCiaro',
			{acidity: 0.0, ethanol: 30.0, sugar: 16.0}),
			_Utils_Tuple2(
			'Amer Picon',
			{acidity: 0.0, ethanol: 15.0, sugar: 20.0}),
			_Utils_Tuple2(
			'Aperol',
			{acidity: 0.0, ethanol: 11.0, sugar: 24.0}),
			_Utils_Tuple2(
			'Benedictine',
			{acidity: 0.0, ethanol: 40.0, sugar: 24.5}),
			_Utils_Tuple2(
			'Campari',
			{acidity: 0.0, ethanol: 24.0, sugar: 24.0}),
			_Utils_Tuple2(
			'Chartreuse, Green',
			{acidity: 0.0, ethanol: 55.0, sugar: 25.0}),
			_Utils_Tuple2(
			'Chartreuse, Yellow',
			{acidity: 0.0, ethanol: 40.0, sugar: 31.2}),
			_Utils_Tuple2(
			'Cointreau',
			{acidity: 0.0, ethanol: 40.0, sugar: 25.0}),
			_Utils_Tuple2(
			'Crême de cacao, white',
			{acidity: 0.0, ethanol: 24.0, sugar: 39.5}),
			_Utils_Tuple2(
			'Crême de violette',
			{acidity: 0.0, ethanol: 20.0, sugar: 37.5}),
			_Utils_Tuple2(
			'Drambuie',
			{acidity: 0.0, ethanol: 40.0, sugar: 30.0}),
			_Utils_Tuple2(
			'Fernet Branca',
			{acidity: 0.0, ethanol: 39.0, sugar: 8.0}),
			_Utils_Tuple2(
			'Luxardo Maraschino',
			{acidity: 0.0, ethanol: 32.0, sugar: 35.0}),
			_Utils_Tuple2(
			'Angostura',
			{acidity: 0.0, ethanol: 44.7, sugar: 4.2}),
			_Utils_Tuple2(
			'Peychauds',
			{acidity: 0.0, ethanol: 35.0, sugar: 5.0}),
			_Utils_Tuple2(
			'Ashmead\'s Kernel apple',
			{acidity: 1.25, ethanol: 0.0, sugar: 14.7}),
			_Utils_Tuple2(
			'Concord grape',
			{acidity: 0.5, ethanol: 0.0, sugar: 18.0}),
			_Utils_Tuple2(
			'Cranberry',
			{acidity: 3.5, ethanol: 0.0, sugar: 13.3}),
			_Utils_Tuple2(
			'Granny Smith apple',
			{acidity: 0.93, ethanol: 0.0, sugar: 13.0}),
			_Utils_Tuple2(
			'Grapefruit',
			{acidity: 2.4, ethanol: 0.0, sugar: 10.4}),
			_Utils_Tuple2(
			'Honeycrisp apple',
			{acidity: 0.66, ethanol: 0.0, sugar: 13.8}),
			_Utils_Tuple2(
			'Orange',
			{acidity: 0.8, ethanol: 0.0, sugar: 12.4}),
			_Utils_Tuple2(
			'Strawberry',
			{acidity: 1.5, ethanol: 0.0, sugar: 8.0}),
			_Utils_Tuple2(
			'Wickson',
			{acidity: 1.25, ethanol: 0.0, sugar: 14.7}),
			_Utils_Tuple2(
			'Champagne acid',
			{acidity: 6.0, ethanol: 0.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Lemon juice',
			{acidity: 6.0, ethanol: 0.0, sugar: 1.6}),
			_Utils_Tuple2(
			'Lime acid orange',
			{acidity: 6.0, ethanol: 0.0, sugar: 0.0}),
			_Utils_Tuple2(
			...
			{acidity: 6.0, ethanol: 0.0, sugar: 1.6}),
			_Utils_Tuple2(
			'Orange juice, lime strength',
			{acidity: 6.0, ethanol: 0.0, sugar: 12.4}),
			_Utils_Tuple2(
			'70 Brix caramel syrup',
			{acidity: 0.0, ethanol: 0.0, sugar: 61.5}),
			_Utils_Tuple2(
			'Butter syrup',
			{acidity: 0.0, ethanol: 0.0, sugar: 42.1}),
			_Utils_Tuple2(
			'Coriander syrup',
			{acidity: 0.0, ethanol: 0.0, sugar: 61.5}),
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			'Maple syrup',
			{acidity: 0.0, ethanol: 0.0, sugar: 87.5}),
			_Utils_Tuple2(
			'Any nut orgeat',
			{acidity: 0.0, ethanol: 0.0, sugar: 61.5}),
			_Utils_Tuple2(
			'Commercial orgeat',
			{acidity: 0.0, ethanol: 0.0, sugar: 85.5}),
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			'Cabernet sauvignon',
			{acidity: 0.56, ethanol: 14.5, sugar: 0.2}),
			_Utils_Tuple2(
			'Coconut water',
			{acidity: 0.0, ethanol: 0.0, sugar: 6.0}),
			_Utils_Tuple2(
			'Espresso',
			{acidity: 1.5, ethanol: 0.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Sour orange juice',
			{acidity: 4.5, ethanol: 0.0, sugar: 12.3}),
			_Utils_Tuple2(
			'Café Zacapa',
			{acidity: 0.75, ethanol: 31.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Chocolate Vodka',
			{acidity: 0.0, ethanol: 40.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Jalapeño Tequila',
			{acidity: 0.0, ethanol: 40.0, sugar: 0.0}),
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			'Milk-Washed Rum',
			{acidity: 0.0, ethanol: 34.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Peanut Butter and Jelly Vodka',
			{acidity: 0.25, ethanol: 32.5, sugar: 16.5}),
			_Utils_Tuple2(
			'Sugared 100 proof',
			{acidity: 0.0, ethanol: 44.0, sugar: 18.5}),
			_Utils_Tuple2(
			'Sugared 80 proof',
			{acidity: 0.0, ethanol: 35.0, sugar: 18.5}),
			_Utils_Tuple2(
			'Tea Vodka',
			{acidity: 0.0, ethanol: 34.0, sugar: 0.0}),
			_Utils_Tuple2(
			'Turmeric Gin',
			{acidity: 0.0, ethanol: 41.2, sugar: 0.0})
		]));
		...
		switch (msg.$) {
			...
			default:
				...
				return _Utils_update(
					model,
					{
						fieldIngredients: A2(author$project$Main$toggle, ingredient, model.fieldIngredients)
					});
		}
	});
...
var author$project$Main$ingredientsQuantityHaveReachedtheLimit = function (ingredients) {
	return _Utils_cmp(
		elm$core$List$length(
			author$project$Main$filteredIngredients(ingredients)),
		author$project$Main$maxIngredientSelectable) > -1;
};
				...
				_List_fromArray(
					[
						...
						A2(
							elm$core$List$map,
							function (ingredient) {
								var value = A2(elm$core$Dict$get, ingredient, model.fieldIngredients);
								var isDisabled = author$project$Main$ingredientsQuantityHaveReachedtheLimit(model.fieldIngredients) && (!A2(elm$core$Maybe$withDefault, false, value));
								var isChecked = A2(elm$core$Maybe$withDefault, false, value);
								return A2(
									elm$html$Html$label,
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													_Utils_Tuple2('checkbox', true),
													_Utils_Tuple2('disabled', isDisabled),
													_Utils_Tuple2('checked', isChecked)
												]))
										]),
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													...
													author$project$Main$ToggleIngredient(ingredient))
												]),
											_List_Nil),
											elm$html$Html$text(' ' + ingredient)
										]));
							},
							elm$core$Dict$keys(model.fieldIngredients))),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var author$project$Main$view = author$project$Main$viewForm;
